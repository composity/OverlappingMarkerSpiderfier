...
h2. The purpose of this fork

This repository is a fork of "jawj/OverlappingMarkerSpiderfier":https://github.com/jawj/OverlappingMarkerSpiderfier. It contains _no modification_ to the original source code, but includes a bower package file and a compiled and minified Javascript file for you to use.

h2. Overlapping Marker Spiderfier — say what?
